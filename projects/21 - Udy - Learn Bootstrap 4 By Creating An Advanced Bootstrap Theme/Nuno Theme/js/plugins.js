...
$(window).ready(function() {
  $(window).scroll(function() {
    $('.navbar').toggleClass('solid', $(this).scrollTop() >= 300);
  });

  $('.navbar-toggler').on('click', function() {
    if ($(window).scrollTop() <= 300) {
      $('.navbar').toggleClass('solid-toggler');
    }
  });
});
      ...
      osTrigger.waypoint(
        function() {
          ...
          osElement
            ...
            .addClass('animate__' + osAnimationClass); //add animated and the data-animation class to the element.
        },
        {
